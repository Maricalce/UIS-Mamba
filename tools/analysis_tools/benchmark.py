...
def parse_args():
    ...
    parser.add_argument('--config',
                        ...
                        # default="/root/data1/yzj/WaterMask/configs/_our_/water_r50_fpn_ms3x.py",
                        help='test config file path')
    parser.add_argument('--checkpoint',
                        default="/root/data1/yzj/WaterMask/tools/work_dirs/mask_rcnn_vssm_fpn_coco_tiny_ms_3x/epoch_36.pth",
                        # default="/root/data1/yzj/WaterMask/configs/_our_/watermask.pth",
...
def measure_inference_speed(cfg, checkpoint, max_iter, log_interval,
    ...
    model = MMDataParallel(model.cuda())  # 🧨 使用普通数据并行
    model.eval()
...
def main():
    ...
    if args.launcher != 'none':  #  仅非none时初始化
        init_dist(args.launcher, **cfg.dist_params)
