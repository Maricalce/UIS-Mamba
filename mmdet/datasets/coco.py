...
class CocoDataset(CustomDataset):
    ...
    # PALETTE = [ (173, 216, 230),   # 鱼 - 浅蓝色 (LightBlue)
    # (255, 160, 122),   # 珊瑚礁 - 浅珊瑚色 (LightSalmon)
    # (144, 238, 144),   # 水生植物 - 浅绿色 (LightGreen)
    # (210, 180, 140),   # 沉船/遗迹 - 浅卡其色 (Tan)
    # (255, 182, 193),   # 潜水员 - 浅粉色 (LightPink)
    # (221, 160, 221),   # 探测器 - 浅紫色 (Plum)
    # (211, 211, 211) ]   # 海底 - 浅灰色 (LightGray)]
